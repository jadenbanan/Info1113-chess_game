...
import XXLChess.App;
import XXLChess.movementBehaviour.KnightKingMovement;
...
public class KnightKing extends Piece {
    ...
    private MovementStrategy movement = new KnightKingMovement();

    public KnightKing(int x, int y, boolean isWhite, JSONObject json) {
